...
enum class EGAMagnitudeCalculation : uint8
{
	...
	SummedAttributeBased, //Calculate based on multiple attributes summed from multiple sources.
...
struct GAMEABILITIES_API EnumToString
{
...
*/
struct GAMEABILITIES_API FGAHashedGameplayTagContainer
{
public:
...
*/
USTRUCT(BlueprintType)
struct GAMEABILITIES_API FGAAttribute
{
	GENERATED_USTRUCT_BODY()
public:
...
struct FGAEffectMod
{
	...
	*/
	...
	FGAEffectMod(const FGAAttribute& AttributeIn, float ValueIn,
		EGAAttributeMod AttributeModIn, FGAEffectHandle HandleIn)
...
*/
USTRUCT(BlueprintType)
struct GAMEABILITIES_API FGAModifier
{
	GENERATED_USTRUCT_BODY()
public:
	UPROPERTY()
...
USTRUCT(BlueprintType)
struct GAMEABILITIES_API FGAEffectContext
{
	GENERATED_USTRUCT_BODY()
public:
	/*
	...
	*/
	...
	inline bool IsValid() const
	{
		/*if (Target.IsValid() && Causer.IsValid() && Instigator.IsValid() && TargetComp.IsValid() && InstigatorComp.IsValid())
			return true;*/
		if (Causer.IsValid() && Instigator.IsValid() && InstigatorComp.IsValid())
			return true;
...
USTRUCT()
struct GAMEABILITIES_API FGACountedTagContainer
{
	GENERATED_USTRUCT_BODY()
protected:
	/*
...
USTRUCT(BlueprintType)
struct GAMEABILITIES_API FGAEffectCueParams
{
	GENERATED_USTRUCT_BODY()
public:
