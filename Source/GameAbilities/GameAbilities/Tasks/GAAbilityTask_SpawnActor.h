 ...
 */
UCLASS()
class GAMEABILITIES_API UGAAbilityTask_SpawnActor : public UGAAbilityTask
{
	GENERATED_BODY()
public:
	...
	UFUNCTION(BlueprintCallable, meta = (HidePin = "WorldContextObject", DefaultToSelf = "WorldContextObject", BlueprintInternalUseOnly = "true"), Category = "Game Abilities | Tasks")
		static UGAAbilityTask_SpawnActor* SpawnActor(UObject* WorldContextObject, TSubclassOf<AActor> Class);
