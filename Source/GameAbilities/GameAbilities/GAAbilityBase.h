...
class GAMEABILITIES_API UGAAbilityBase : public UObject, public IIGIPawn, public IGameplayTaskOwnerInterface, public IIGAAbilities
{
	GENERATED_BODY()
public:
	/* Ability configs */
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Base Config")
		FGAAttribute ActivationTimeAttribute;

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Base Config")
		FGAAttribute PeriodTimeAttribute;

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Base Config")
		FGAAttribute CooldownTimeAttribute;
	...
	*/
	...
	UPROPERTY(BlueprintReadOnly, Category = "Default")
		class UGAAbilitiesComponent* AttributeComponent;
	/* 
	...
	*/
	UPROPERTY(EditAnywhere, Category = "Config")
		FGAEffectSpec AbilityAttributeCost;
...
public: //because I'm to lazy to write all those friend states..
	UPROPERTY()
		FGAEffectHandle CooldownHandle;
	UPROPERTY()
		FGAEffectHandle AttributeCostHandle;
	UPROPERTY()
...
public:
	...
	*/
	UFUNCTION(BlueprintImplementableEvent, Category = "Game Abilities System")
		void OnAbilityActivationFinished();

	/* Event called when ability activation has been canceled. */
	UFUNCTION(BlueprintImplementableEvent, Category = "Game Abilities System")
		void OnAbilityActivationCancel();
	...
	*/
	/* Effect Helpers */
	UFUNCTION(BlueprintCallable, Category = "Game Abilities System")
		FGAEffectHandle ApplyEffectToActor(const FGAEffectSpec& SpecIn,
			FGAEffectHandle HandleIn, class AActor* Target, class APawn* Instigator,
			UObject* Causer);

	UFUNCTION(BlueprintCallable, Category = "Game Abilities System")
		FGAEffectHandle ApplyEffectFromHit(const FGAEffectSpec& SpecIn,
			FGAEffectHandle HandleIn, const FHitResult& HitIn, class APawn* Instigator,
			UObject* Causer);

	void RemoveEffectFromActor(FGAEffectHandle& HandleIn, class AActor* TargetIn);
...
protected:
	...
	void AddTagsToEffect(FGAEffect* EffectIn);
public: //protected ?
