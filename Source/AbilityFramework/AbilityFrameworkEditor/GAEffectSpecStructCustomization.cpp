...
public:
	...
	bool ConfigureProperties(FGAEffectSpecStructCustomization* InGameplayAbilitiesBlueprintFactory)
	{
...
private:
	...
	FGAEffectSpecStructCustomization* GameplayAbilitiesBlueprintFactory;
...
TSharedRef<IPropertyTypeCustomization> FGAEffectSpecStructCustomization::MakeInstance()
{
	return MakeShareable(new FGAEffectSpecStructCustomization);
}

FGAEffectSpecStructCustomization::~FGAEffectSpecStructCustomization()
{

}

void FGAEffectSpecStructCustomization::CustomizeHeader(TSharedRef<IPropertyHandle> InStructPropertyHandle, FDetailWidgetRow& HeaderRow, IPropertyTypeCustomizationUtils& StructCustomizationUtils)
{
	StructPropertyHandle = InStructPropertyHandle;
	TAttribute<FText> EffectName;// ();
	EffectName.Create(TAttribute<FText>::FGetter::CreateRaw(this, &FGAEffectSpecStructCustomization::GetClassName));
	/*SNew(SVerticalBox)
		+ SVerticalBox::Slot()
		[
			SNew(STextBlock)
	...
	EffectPropertyHandle = InStructPropertyHandle->GetChildHandle(TEXT("SpecClass"));
	HeaderRow
		.NameContent()
		[
		...
		.ValueContent()
		[
			//SpecClassHandle->CreatePropertyValueWidget()
			
			SNew(SHorizontalBox)
			+SHorizontalBox::Slot()
			[
				SAssignNew(ComboButton, SComboButton)
				.OnGetMenuContent(this, &FGAEffectSpecStructCustomization::GenerateClassPicker)
				.ContentPadding(FMargin(2.0f, 2.0f))
				.ToolTipText(this, &FGAEffectSpecStructCustomization::GetDisplayValueAsString)
				.ButtonContent()
				[
					SNew(STextBlock)
					.Text(this, &FGAEffectSpecStructCustomization::GetDisplayValueAsString)
				//.Font(InArgs._Font)
				]
			]
			+ SHorizontalBox::Slot()
			...
			[
				SNew(SButton)
				.OnClicked(this, &FGAEffectSpecStructCustomization::OnEditButtonClicked)
				[
					SNew(STextBlock)
...
void FGAEffectSpecStructCustomization::CustomizeChildren(TSharedRef<IPropertyHandle> InStructPropertyHandle, IDetailChildrenBuilder& StructBuilder, IPropertyTypeCustomizationUtils& StructCustomizationUtils)
{

}
FText FGAEffectSpecStructCustomization::GetClassName() const
{
...
FText FGAEffectSpecStructCustomization::GetDisplayValueAsString() const
{
...
TSharedRef<SWidget> FGAEffectSpecStructCustomization::GenerateClassPicker()
{
	FClassViewerInitializationOptions Options;
	...
	FOnClassPicked OnPicked(FOnClassPicked::CreateRaw(this, &FGAEffectSpecStructCustomization::OnClassPicked));
...
void FGAEffectSpecStructCustomization::OnClassPicked(UClass* InClass)
{
	if (!InClass)
	{
...
void FGAEffectSpecStructCustomization::SendToObjects(const FString& NewValue)
{
	if (EffectPropertyHandle.IsValid())
	{
...
TSharedRef<SWidget> FGAEffectSpecStructCustomization::MakeNewBlueprintButton()
{
	return
		SNew(SButton)
		...
		.OnClicked(this, &FGAEffectSpecStructCustomization::MakeNewBlueprint)
		.IsEnabled(true)
		.IsFocusable(false)
...
FReply FGAEffectSpecStructCustomization::MakeNewBlueprint()
{
...
FReply FGAEffectSpecStructCustomization::OnEditButtonClicked()
{
		...
		EffectEditorWindow->SetContent(
			...
			[
				...
				[
					...
					[
						SNew(SButton)
						.OnClicked(this, &FGAEffectSpecStructCustomization::OnCloseButtonClicked)
						.IsEnabled(true)
						.IsFocusable(false)
						[
							SNew(STextBlock)
...
FReply FGAEffectSpecStructCustomization::OnCloseButtonClicked()
{
	if (EffectEditorWindow.IsValid())
	{
