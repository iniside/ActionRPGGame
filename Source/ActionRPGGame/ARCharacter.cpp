...
AARCharacter::AARCharacter()
{
	...
	AbilitiesComponent = CreateDefaultSubobject<UGAAbilitiesComponent>(TEXT("AbilitiesComponent"));
...
void AARCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindTouch(IE_Pressed, this, &AARCharacter::TouchStarted);
	PlayerInputComponent->BindTouch(IE_Released, this, &AARCharacter::TouchStopped);

	// VR headset functionality
	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &AARCharacter::OnResetVR);
}


void AARCharacter::OnResetVR()
{
}
