...
UGASpellExecutionTest::UGASpellExecutionTest(const FObjectInitializer& ObjectInitializer)
: Super(ObjectInitializer)
{

}
void UGASpellExecutionTest::ExecuteEffect(FGAGameEffectHandle& HandleIn,
